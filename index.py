...
def filtro_clasificacion():
    ...
    conditionlist = [
        (df2['INSTITUCIÓN DE EDUCACIÓN SUPERIOR'].str.contains('|'.join(FiltroOTROS))),
        (df2['INSTITUCIÓN DE EDUCACIÓN SUPERIOR'] .str.contains('|'.join(FiltroPOLITECNICA))),
        (df2['INSTITUCIÓN DE EDUCACIÓN SUPERIOR'] .str.contains('|'.join(FiltroTECNM))),
        (df2['INSTITUCIÓN DE EDUCACIÓN SUPERIOR'] .str.contains('|'.join(FiltroTECNOLOGIA))),
